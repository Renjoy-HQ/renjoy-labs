      ...
      <div style={{ background: "#1e0f16", color: "#e8e4df", minHeight: "100vh", fontFamily: "'Figtree', sans-serif" }}>
        ...
        <article style={{ padding: "0 40px 80px", position: "relative" }}>
          ...
          <div style={{ maxWidth: "720px", margin: "0 auto", position: "relative", zIndex: 2 }}>
            ...
            <P>Within weeks, San Francisco was a ghost town. Sutter's own laborers deserted him. First they left in small groups, then all of them, from the clerks to the cooks. The <em>San Francisco Californian</em> ran one final editorial lamenting that the whole country echoed with the cry of gold while fields sat half-planted and houses half-built. Then the newspaper's staff walked off the job too.</P>
            ...
            <P>The ground under your feet is different than it was two years ago. Heck, even two months ago. And the most natural human response to that kind of shift is to stand still and wait for clarity, to tell yourself you'll adopt AI when the technology matures, when it's less risky, when everyone else has figured it out first.</P>
            ...
            <P>What I love about Brannan's story is that it wasn't luck. He saw the information asymmetry and positioned himself in the path of everyone who would chase it.</P>

            <P>And Brannan wasn't even the most interesting example, just the most brazen. Armour, Strauss, Stanford, a half-dozen others all made fortunes off the rush without mining a single ounce. Different plays and different industries but the same approach: instead of chasing the gold, position yourself in the path of the people who are.</P>
            ...
            <P>The miners went bust when the easy placer gold dried up. The merchants built dynasties.</P>

            <H2 id="color">Finding color</H2>

            <P>There's a mining term from the diggings called "finding color" — when minute particles of gold appear in your pan. Not necessarily enough to celebrate, just the first sign that something valuable might be present in the ground you're working. That's where most of us are right now with AI. I call this stage "finding color" because it captures something the tech industry's language doesn't: that early moment where you can see it working but you can't yet prove it at scale. You've found color. Now what?</P>
            ...
            <P>Sutter failed because he couldn't let go of the model that used to work. And the most dangerous part? His business was still profitable when the shift started. The signs that you're falling behind don't show up in this quarter's revenue. They show up in the gap between what your team is doing manually and what your competitors are automating.</P>

            <H2 id="behind">What gold rushes leave behind</H2>

            <P>The strongest argument for embracing any gold rush is what it builds.</P>

            <P>Here's the detail that gets me: California agriculture. The Central Valley is now one of the most productive farming regions on earth. It was literally seeded by miners who failed at gold but stayed for the land. They came to extract minerals and ended up building farms. The rush pulls people in for one reason, and the ones who stick around create something nobody planned.</P>

            <P>San Francisco went from 200 people to 57,000 in fourteen years. Wells Fargo exists because someone needed to run banking for gold camps. The Transcontinental Railroad was funded by merchant profits from the rush. None of that was the point, yet all of it outlasted the gold.</P>

            <P>The one that really surprises people is Alaska. The U.S. bought it in 1867 and the country mocked the deal for thirty years. You may remember from high school history lessons the name it was given: "Seward's Folly." Then the Klondike happened and suddenly the gateway to the northern gold fields was American territory. The purchase price paid for itself many times over, but only because a gold rush nobody predicted vindicated a bet nobody understood at the time.</P>

            <P>I think about that when people ask whether AI is a bubble. Maybe it is. I don't think that's actually the right question though... The dot-com bubble was a bubble too, but it left behind the fiber-optic cables that power the modern internet. Railroad speculation in the 1800s was reckless by any measure, and those tracks carried freight for a century after the speculators went broke. The frenzies often look stupid in real time. But the infrastructure they fund outlasts the speculation every time. So if AI is a bubble, the question isn't whether it'll pop, it's what gets built before it does.</P>

            <P><a href="/essays/the-mulrooney-play" style={{color:"#d4897a",textDecoration:"none",borderBottom:"1px solid rgba(212,137,122,0.3)"}}>Belinda Mulrooney</a>, the Klondike's richest woman, understood this intuitively. She arrived in Dawson with goods she'd hauled over the Chilkoot Pass. Things like silk underwear, cotton cloth, hot water bottles. Once she arrived, she tossed her last coin into the river. Her goods netted a 600% profit. She built Dawson's finest hotel and brought the town its first telephone. She understood something the miners missed: the opportunity wasn't in the gold. It was in the people who came for the gold.</P>
            ...
            <P>Here's what the gold rushes actually teach us: most people lost. The miners went broke when the streams dried up, the skeptics showed up too late, and Sutter lost everything because he couldn't stop being a farmer long enough to notice the world had changed.</P>

            <P>The people who built lasting wealth weren't smarter or luckier. They just asked a different question. Instead of "where's the gold?" they asked "what do the people chasing gold actually need?" Brannan figured it out first with supply chains. <a href="/essays/the-mulrooney-play" style={{color:"#d4897a",textDecoration:"none",borderBottom:"1px solid rgba(212,137,122,0.3)"}}>Mulrooney</a> figured it out with hospitality. The others landed somewhere in between. But none of them mined gold.</P>

            <P>The barrier to building something right now has never been lower. An API key, a laptop, and an idea worth testing. That's it.</P>

            <P>But "build something" isn't enough. The gold rushes are specific about what works, and I'd argue they're the best AI business strategy framework nobody's using. Solve a real problem that the rush itself creates. Build the infrastructure that everyone else depends on. Serve the people who show up, not the resource they're chasing. And if you're already running a company, ask yourself the hardest question Sutter never asked: is the model you're protecting still the model worth building?</P>

            <P>I think about this every day at my own company. We manage vacation rental properties, and honestly, this industry has operated like miners for as long as I've been in it. Chasing bookings. Clinging to manual processes. Treating every property as something to extract revenue from rather than something to build around.</P>

            <P>We're trying to do it differently with AI-first operations, systems that actually scale and actively complete workflows, not just 70% of a workflow. Whether it's working fully as envisioned is a fair question! Some of it is, while some of it we're still figuring out. But the bet we've made is that the opportunity isn't going anywhere!</P>

            <P>We believe the new limits in the age of AI are ambition, creativity, and the laws of physics.</P>
            ...
            <div style={{
              ...
              This is the first essay in a series on what the gold rushes teach us about building companies in the age of AI. The second essay, <a href="/essays/the-mulrooney-play" style={{color:"#d4897a",textDecoration:"none",borderBottom:"1px solid rgba(212,137,122,0.3)"}}>The Mulrooney Play</a>, explores the defining strategic choice for VRM operators. The third, <a href="/essays/the-sutter-trap" style={{color:"#d4897a",textDecoration:"none",borderBottom:"1px solid rgba(212,137,122,0.3)"}}>The Sutter Trap</a>, examines why the best operators are the most at risk.
            </div>
          </div>
        </article>
